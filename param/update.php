...
if(isset($_POST['submit'])) {
    ...
    //On l'insère à nouveau
    $query = $conn->prepare("INSERT INTO Contact(id,nom,prenom,relation,mail) VALUES (:id,:nom,:prenom,:relation,:mail) ");
    ...
    if ( !$query->execute() ){
        ...
        header("Location:gestionContact.php?error=".$msg);
    }
